...
namespace Add_data
{
    internal class AddProf
    {
        public void  addP(string firstName, string lastName, string age, string email)
        {
            try
            {
                StreamWriter stream = new StreamWriter("professor.txt", true);
